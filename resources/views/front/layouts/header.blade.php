...
<div class="container-fluid bg-dark py-2 d-none d-md-flex">
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <small class="text-secondary d-none d-xl-block">Note : Nous vous aidons à développer votre entreprise</small>
                ...
                <ul class="navbar-nav ms-auto mx-xl-auto gap-2">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('ticafrique.about') }}"
                            class="nav-link {{ request()->routeIs('about') ? 'text-info' : 'text-dark' }}">À propos</a>
                    </li>
                    <li class="nav-item">

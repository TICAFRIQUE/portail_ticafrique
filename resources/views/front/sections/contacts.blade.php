            ...
            <div class="contact-detail position-relative p-5">
                    ...
                    <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".5s">
                        <div class="d-flex bg-light p-3 rounded align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <a class="h5" href="tel:+2252522002077"> +225 25 220 020 77</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                        <div class="p-5 rounded contact-form bg-light shadow-sm">
                            <form>
                                <div class="mb-4">
                                ...
                                <div class="text-start">
                                    <button class="btn btn-primary py-3 px-5" type="button">Envoyer</button>
                                </div>
                            </form>
                        </div>
                    </div>

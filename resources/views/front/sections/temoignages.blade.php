            ...
            <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay=".5s">
                ...
                <div class="testimonial-item border p-4">
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ asset('site/img/testimonial-1.jpg') }}" alt="">
                        </div>
                        <div class="ms-4">
                ...
                <div class="testimonial-item border p-4">
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ asset('site/img/testimonial-2.jpg') }}" alt="">
                        </div>
                        <div class="ms-4">
                            <h4 class="text-secondary">Client Name</h4>
                            <p class="m-0 pb-3">Profession</p>
                ...
                <div class="testimonial-item border p-4">
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ asset('site/img/testimonial-3.jpg') }}" alt="">
                        </div>
                        <div class="ms-4">
                            <h4 class="text-secondary">Client Name</h4>
                            <p class="m-0 pb-3">Profession</p>
                ...
                <div class="testimonial-item border p-4">
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ asset('site/img/testimonial-4.jpg') }}" alt="">
                        </div>
                        <div class="ms-4">
                            <h4 class="text-secondary">Client Name</h4>
                            <p class="m-0 pb-3">Profession</p>
